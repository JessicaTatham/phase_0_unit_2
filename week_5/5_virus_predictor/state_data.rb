...
#This input is giving the 50 states with their population, population density aand region/regional spread. 

# STATE_DATA is a hash that hold hashes. The first hash, holds the rest of the hashes in standard format. The
# second level of hashes, holds data in the form of symbols. 
